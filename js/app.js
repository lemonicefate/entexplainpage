...
(function () {
  ...
  var CALCULATORS = [
    ...
    {id:'wegovy',    title:'週纖達針劑換算 (Wegovy)', subtitle:'Semaglutide FlexTouch 諾特筆劑量、體積與喀噠互算', type:'calc', kind:'calc', category:'calc', categories:['calc'], tabLabel:'週纖達', thumbnail:'images/wegovy/wegovy-logo-nav.webp', thumbnailMode:'logo'}
  ];
